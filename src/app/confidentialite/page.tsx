    ...
    <main className="min-h-screen bg-[#FAF8F5]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-8 text-[#374151]">
        ...
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-bold text-[#3E4743] mb-4 pb-2 border-b border-[#F3E4CD]">1. Introduction</h2>
        ...
        {/* Données collectées */}
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-bold text-[#3E4743] mb-4 pb-2 border-b border-[#F3E4CD]">2. Données collectées</h2>
          <div className="space-y-4 text-sm leading-relaxed">
            <p>Lors de votre abonnement, nous collectons les données suivantes :</p>

            <div className="overflow-hidden rounded-xl border border-gray-100">
              <table className="w-full text-sm">
                <thead className="bg-[#F3E4CD]">
                  <tr>
                    <th className="text-left px-4 py-2 text-[#3E4743] font-semibold">Donnée</th>
                    <th className="text-left px-4 py-2 text-[#3E4743] font-semibold">Finalité</th>
                    <th className="text-left px-4 py-2 text-[#3E4743] font-semibold">Base légale</th>
                  </tr>
                </thead>
        ...
        {/* Destinataires */}
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-bold text-[#3E4743] mb-4 pb-2 border-b border-[#F3E4CD]">3. Destinataires des données</h2>
          <div className="space-y-3 text-sm leading-relaxed">
        ...
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-bold text-[#3E4743] mb-4 pb-2 border-b border-[#F3E4CD]">4. Durée de conservation</h2>
        ...
        {/* Vos droits */}
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-bold text-[#3E4743] mb-4 pb-2 border-b border-[#F3E4CD]">5. Vos droits</h2>
          <div className="space-y-3 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={droit} className="bg-[#F6EBDB] rounded-lg p-3">
                  <div className="font-semibold text-[#5C6B65] text-xs">{droit}</div>
            ...
            <p>
              ...
              <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-[#5C6B65] hover:underline">
                CNIL
              </a>{' '}
        ...
        {/* Sécurité */}
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-bold text-[#3E4743] mb-4 pb-2 border-b border-[#F3E4CD]">6. Sécurité des données</h2>
          <div className="space-y-3 text-sm leading-relaxed">
            <p>
        ...
        {/* Cookies */}
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-bold text-[#3E4743] mb-4 pb-2 border-b border-[#F3E4CD]">7. Cookies</h2>
          <div className="space-y-2 text-sm leading-relaxed">
            <p>
        ...
        {/* Modifications */}
        <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-lg font-bold text-[#3E4743] mb-4 pb-2 border-b border-[#F3E4CD]">8. Modifications</h2>
